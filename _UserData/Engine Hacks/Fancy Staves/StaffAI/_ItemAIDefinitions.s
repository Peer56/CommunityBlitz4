...
.set AIActionStruct,                   0x0203AA94 		@shortened to AAS
.set turnList,                         0x0203AA04 		@update name later
.set ActiveUnit,                       0x03004E50 		
.set ActiveUnitInfo,                   0x0202BE44 		
	@holds unit deployment id and coordinates of active unit
@Routines
	...
	.set AddRange,                          0x0801AABC 	@build targeting range in range map

	.set MagicSealCheck,                    0x0801B950 	@check where the magic seal is
	.set MovBuild,                          0x0803C490 	@build movement range; parameters: r0 = ram character pointer
	.set IsTileReachable,                   0x0803BFD0 	@parameters: r0 = x of acting unit, r1 = y of acting unit, r2 = x of target unit/tile, r3 = y of target unit/tile

	@Action related routines
	.set FindNewSpot,                       0x0803C284 	@find where unit will move to use staff
	.set ActionWrite,                       0x08039C20	@write info to AAS
